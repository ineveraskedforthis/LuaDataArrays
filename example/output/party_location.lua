...
function PARTY_LOCATION.create(state, party_as_party, location_as_location)
	...
	if state.party_reference_as_unique_party_in_party_location_table[party_as_party % 4294967296] ~= nil then
		PARTY_LOCATION.delete_unsafe(state, state.party_reference_as_unique_party_in_party_location_table[party_as_party % 4294967296])
	end
	...
	if state.location_referenced_as_one_of_location_in_party_location_table[location_as_location % 4294967296] then state.location_referenced_as_one_of_location_in_party_location_table[location_as_location % 4294967296][id] = id else state.location_referenced_as_one_of_location_in_party_location_table[location_as_location % 4294967296] = {  }; state.location_referenced_as_one_of_location_in_party_location_table[location_as_location % 4294967296][id] = id; end
...
function PARTY_LOCATION.delete(state, party_location_id)
	...
	state.party_location_generation[party_location_id % 4294967296] = (state.party_location_generation[party_location_id % 4294967296] + 1)
	state.party_reference_as_unique_party_in_party_location_table[state.party_location_link_party_from_party_table[party_location_id % 4294967296]] = nil
	state.party_location_link_party_from_party_table[party_location_id % 4294967296] = 0

	if state.location_referenced_as_one_of_location_in_party_location_table[state.party_location_link_location_from_location_table[party_location_id % 4294967296]] then state.location_referenced_as_one_of_location_in_party_location_table[state.party_location_link_location_from_location_table[party_location_id % 4294967296]][party_location_id % 4294967296] = nil end
	state.party_location_link_location_from_location_table[party_location_id % 4294967296] = 0
...
function PARTY_LOCATION.delete_unsafe(state, raw_id)
	state.party_location_generation[raw_id] = (state.party_location_generation[raw_id] + 1)
	state.party_reference_as_unique_party_in_party_location_table[state.party_location_link_party_from_party_table[raw_id]] = nil
	state.party_location_link_party_from_party_table[raw_id] = 0

	if state.location_referenced_as_one_of_location_in_party_location_table[state.party_location_link_location_from_location_table[raw_id]] then state.location_referenced_as_one_of_location_in_party_location_table[state.party_location_link_location_from_location_table[raw_id]][raw_id] = nil end
	state.party_location_link_location_from_location_table[raw_id] = 0
