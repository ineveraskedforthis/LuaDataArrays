...
function PARTY_LOCATION.create(state, party_as_party, location_as_location)
	...
	if state.party_reference_as_unique_party_in_party_location_table[party_as_party % 4294967296] != nil then
		state.party_location_delete_weak(state.party_reference_as_unique_party_in_party_location_table[party_as_party % 4294967296])
	end
	...
	if state.location_reference_as_unique_location_in_party_location_table[location_as_location % 4294967296] then state.location_reference_as_unique_location_in_party_location_table[location_as_location % 4294967296][id] = value else state.location_reference_as_unique_location_in_party_location_table[location_as_location % 4294967296] = {  }; state.location_reference_as_unique_location_in_party_location_table[location_as_location % 4294967296][id] = value; end
